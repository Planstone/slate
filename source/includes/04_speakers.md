...
```shell
curl "https://apps.planion.com/feed/v1/speakers?where={"account":"ACCOUNT","conference":"CONTAINER_ID"}" \
...
The Speakers method gives a listing of all people attached to a session.


### HTTP Request

`GET https://apps.planion.com/feed/v1/speakers?where={"account":"ACCOUNT","conference":"CONTAINER_ID"}`
