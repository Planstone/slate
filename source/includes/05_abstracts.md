...
```shell
curl "https://apps.planion.com/feed/v1/abstracts?where={"account":"ACCOUNT","conference":"CONTAINER_ID"}" \
...
The abstracts method lists all abstracts that originated in the Planstone system.  Depending on the setup and specific business processes for an event, there may or may not be data for this method.  Please ask your account manager if you’d like to use this method.

To use this system, you must use the Planstone Abstract Module and have “Sessionized” your abstracts into your meeting container.


### HTTP Request

`GET https://apps.planion.com/feed/v1/abstracts?where={"account":"ACCOUNT","conference":"CONTAINER_ID"}`
