...
```shell
curl "https://apps.planion.com/feed/v1/eposters?where={"account":"ACCOUNT","conference":"CONTAINER_ID"}" \
...
The ePosters method lists all ePosters that originated in the Planstone system.  Depending on the setup and specific business processes for an event, there may or may not be data for this method.  Please ask your account manager if you’d like to use this method.

To use this method, you must be utilizing the Planstone ePoster Module.


### HTTP Request

`GET https://apps.planion.com/feed/v1/eposters?where={"account":"ACCOUNT","conference":"CONTAINER_ID"}`
